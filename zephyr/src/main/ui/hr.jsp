        ...
        <div id="body" class="unselect">
            ...
            <div id="content">
                ...
                <div id="competitions">
                    ...
                    <div id="sidebar">
                        <a href="hr.html">Activities:</a>                      
                        <a href="" id="info">1. Submit hostel participant list</a>                                     <!-- need to set action link-->
                    </div>
         ...
         <div id="footer" class="unselect">
            ...
            <a href="developers.html" id="info">Developers                                                             <!-- need to set action link-->
