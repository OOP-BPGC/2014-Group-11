        ...
        <div id="body" class="unselect">
            ...
            <div id="content">
                ...
                <div id="competitions">
                    ...
                    <div id="sidebar">
                        <a href="student.html">Activities:</a>                      
                        <a href="" id="info">1. Buy Tickets</a>                                     <!-- need to set action link-->
                        <a href="" id="info">2. Buy Passes</a>                                      <!-- need to set action link-->
                        <a href="" id="info">3. Register for an Event</a>                           <!-- need to set action link-->
                    </div>

                    <div id="hrule" style="height: 0px" ></div>

                    <h2 style="margin-left: 320px;">Notification Board:</h2>
                    <h4 style="margin-left: 320px;">/*here is the place where we show notifications*/</h4>
